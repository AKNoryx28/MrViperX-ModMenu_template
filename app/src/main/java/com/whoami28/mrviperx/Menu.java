        ...
        for (int i = 0; i < lists.size(); i++) {
            ...
            View.OnClickListener first_radio_listener = new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    Preferences.changeFeatureInt(finalFeatName, featNum, radioGroup.indexOfChild(Radio));
                }
            };
            System.out.println(lists.get(i));
            Radio.setText(lists.get(i));
            Radio.setTextColor(Color.LTGRAY);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                Radio.setButtonTintList(ColorStateList.valueOf(RadioColor));
            Radio.setOnClickListener(first_radio_listener);
