...
int RegisterMenu(JNIEnv *env) {
    ...
    jclass clazz = env->FindClass(OBFUSCATE("com/whoami28/mrviperx/Menu"));
    if (!clazz)
        return JNI_ERR;
...
int RegisterPreferences(JNIEnv *env) {
    ...
    jclass clazz = env->FindClass(OBFUSCATE("com/whoami28/mrviperx/Preferences"));
    if (!clazz)
        return JNI_ERR;
    if (env->RegisterNatives(clazz, methods, sizeof(methods) / sizeof(methods[0])) != 0)
        return JNI_ERR;
...
int RegisterMain(JNIEnv *env) {
    ...
    jclass clazz = env->FindClass(OBFUSCATE("com/whoami28/mrviperx/Main"));
    if (!clazz)
        return JNI_ERR;
    if (env->RegisterNatives(clazz, methods, sizeof(methods) / sizeof(methods[0])) != 0)
        return JNI_ERR;
